...
/* mainSelected.addEventListener("click", function () {
  if (mainSelected.style.backgroundColor == "yellow") {
    mainSelected.style.backgroundColor = "blue";
    document.querySelector("#paragraphOne").innerHTML = "I'm feeling blue!";
  } else { mainSelected.style.backgroundColor = "yellow";
  document.querySelector("#paragraphOne").innerHTML = "I'm feeling yellow!";
}
}); */